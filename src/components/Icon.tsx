// 统一线性描边图标集(Feather 风格,24×24,stroke=currentColor)。
// 继承文字颜色,与纸墨衬线风格一致;替代原先的彩色 emoji。
import type { ReactNode } from "react";

export type IconName =
  | "book" | "sparkles" | "bookmark" | "volume" | "star" | "link" | "text"
...
const ICONS: Record<IconName, ReactNode> = {
  ...
  sparkles: <><path d="M12 3l1.6 4.8L18.5 9.5l-4.9 1.7L12 16l-1.6-4.8L5.5 9.5l4.9-1.7z" fill="currentColor" stroke="none" /><path d="M19 14l.7 2 2 .7-2 .7-.7 2-.7-2-2-.7 2-.7z" fill="currentColor" stroke="none" /></>,
